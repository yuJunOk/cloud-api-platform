...
import type { LoginByAccountDto } from '../models/LoginByAccountDto';
...
export class UserControllerService {
     ...
     * @throws ApiError
     */
    public static logout(): CancelablePromise<ResponseEntityObject> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/logout',
        });
     ...
     * @throws ApiError
     */
    public static loginByAccount(
        requestBody: LoginByAccountDto,
    ): CancelablePromise<ResponseEntityLoginUserBo> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/login/account',
